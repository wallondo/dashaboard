...
import "./produtos_parados.css";
import { Link } from "react-router-dom";
import { Dados } from "../../src/dados";

function P_Parados(params) {
 ...
 return(  <div className="m_vendidos">
        <h3>Os Produtos Parados até ao momento</h3>
            ...
            <section className="sec_m_vendidos">
                 {
                                pro_all.map((product,pos)=>(
                                    (product.n_venda==0? <div className="product" key={pos}>
                                        <h3>{product.nome}</h3>
